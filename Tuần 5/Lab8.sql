...
BEGIN
    ...
    BEGIN
        SELECT 1 AS 'MãLỗi', 'Giới tính không hợp lệ' AS 'MoTaLoi'
        RETURN
    END
    ...
    BEGIN
        ...
        SELECT 0 AS 'MãLỗi', 'Thêm mới nhân viên thành công' AS 'MoTaLoi'
    END
...
END
go
EXEC lab8_c1 @manv = '01',@tennv=N'Mai', @gioitinh = N'Nữ', @diachi = N'Bình Dương', @email = N'mai@gmail.com', 
